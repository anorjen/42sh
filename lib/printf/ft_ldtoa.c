...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/02/17 15:52:52 by sbearded          #+#    #+#             */
/*   Updated: 2019/02/18 14:51:13 by sbearded         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char		*floatpart_maker(long double n, int prec, long *intpart)
{
	...
	if (prec == 0)
		return (zeroprec2(floatpart, *intpart));
	floatres = ft_strnew(prec + 500);
	floatpart += roundgenerator2(prec);
...
static char		*retconst(char *frdy, char *ires, char *fres, long double n)
{
	if (n == 0.0)
	{
