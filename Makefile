...
NAME_INPUT = assist_func.c cut_copy_paste.c cut_paste.c history_session.c input.c navigation_words.c navigation.c save_buff.c spec_key.c
NAME_VECTOR = vector.c

SRC = $(addprefix $(SRC_MINISHELL), $(NAME_MINISHELL)) $(addprefix $(SRC_LAUNCH), $(NAME_LAUNCH)) $(addprefix $(SRC_INPUT), $(NAME_INPUT)) $(addprefix $(SRC_VECTOR), $(NAME_VECTOR))
